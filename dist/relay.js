...
/***/ function(module, exports, __webpack_require__) {
	...
	var generateConcreteFragmentID = __webpack_require__(174);
	var invariant = __webpack_require__(2);
	    ...
	    var read = function read(child) {
	      if (child instanceof RelayQuery.Fragment) {
	        if (child.isContainerFragment() && !_this3._traverseFragmentReferences) {
	          ...
	          nextData = nextData || {};
	          var fragmentID = fragmentPointer.getFragment().getConcreteFragmentID();
...
[278, 100],
/* 103 */
[282, 211, 33, 213, 66, 101, 25, 208, 106, 16, 17],
/* 104 */
/***/ function(module, exports, __webpack_require__) {
	        ...
	        if (fragment.isPlural()) {
	          ...
	          if (propValue.length) {
	            dataIDOrIDs = propValue.reduce(function (acc, item, ii) {
	              var eachFragmentPointer = item[fragmentID];
	          ...
	          var fragmentPointer = propValue[fragmentID];
	          if (fragmentPointer) {
	      ...
	      if (true) {
	        ...
	        fragmentNames.forEach(function (fragmentName) {
	          ...
	          _Object$keys(props).forEach(function (propName) {
	             true ? warning(fragmentPointers[propName] || !RelayRecord.isRecord(props[propName]) || !props[propName][fragmentID], 'RelayContainer: Expected record data for prop `%s` on `%s`, ' + 'but it was instead on prop `%s`. Did you misspell a prop or ' + 'pass record data into the wrong prop?', fragmentName, componentName, propName) : undefined;
	          });
	        });
	      }
	    };
